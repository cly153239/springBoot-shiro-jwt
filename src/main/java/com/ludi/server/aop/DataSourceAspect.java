package com.ludi.server.aop;

import com.ludi.server.aop.annotation.DataSourceSwitch;
import com.ludi.server.config.datasource.DynamicDataSourceContextHolder;
import com.ludi.server.enums.DataSourceEnum;
...
public class DataSourceAspect {
    ...
    @Pointcut(value = "@annotation(com.ludi.server.aop.annotation.DataSourceSwitch)")
